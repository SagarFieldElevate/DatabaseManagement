...
existing_records = [
    ...
    if rec['fields'].get('Name') == "Global GDP"
]
...
if record_id:
    ...
    create_airtable_record("Global GDP", raw_url, filename, airtable_url, AIRTABLE_API_KEY)

# Cleanup
delete_file_from_github(filename, GITHUB_REPO, BRANCH, UPLOAD_PATH, GITHUB_TOKEN, file_sha)
os.remove(filename)
print("✅ Global GDP Data: Airtable updated and GitHub cleaned up.")
